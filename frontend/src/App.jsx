...
import AddBiciklPage from './pages/bicikl/AddBiciklPage.jsx'
  ...
  return (
      <>
        ...
        <Routes>
          ...
          <Route
              path="/dodaj-aparat"
              element={loggedInUser?.userType === "ZAPOSLENI" ? <AddBiciklPage loggedInUser={loggedInUser}/> : <Navigate to="/" replace/>}
          />
          <Route
              path="/klijenti"
